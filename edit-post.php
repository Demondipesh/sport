...
if (isset($_GET['id'])) {
    ...
    $sql_post = "SELECT id, description, image, player_name FROM posts WHERE id = '$post_id' AND uploaded_by = '$user_name'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql_update = "UPDATE posts SET description = '$newDescription', player_name = '$newFoodName' WHERE id = '$post_id'";
    ...
    <section class="edit-post-section">
        ...
        <div class="edit-post-form">
            <form method="POST" enctype="multipart/form-data">
                ...
                <label for="player_name">Food Name:</label>
                <input type="text" name="player_name" id="player_name" value="<?php echo $foodName; ?>" required>
