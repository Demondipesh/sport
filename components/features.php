<div class="containerp w-full bg-gray-800">
                <p class="container-titlea">Our Features</p>
                ...
                <div class="gradient-cards">
                    <div class="cardp">
                        <div class="container-card bg-green-box">
                            ...
                            <p class="card-title">Post Sports Stuffs</p>
                            <p class="card-description">Post your sports-related stuffs on our platform and share your passion with the world!</p>
                        </div>
                    </div>
                    ...
                    <div class="cardp">
                        <div class="container-card bg-white-box">
                            ...
                            <p class="card-title">Live Sports Scores</p>
                            <p class="card-description">Stay up-to-date with the latest scores and results from your favorite sports leagues and teams, including football, basketball, baseball, and more.</p>
                        </div>
                    </div>
                    ...
                    <div class="cardp">
                        <div class="container-card bg-yellow-box">
                            ...
                            <p class="card-title">Live Sports Betting</p>
                            <p class="card-description">Bet on your favorite sports teams and leagues, including football, basketball, baseball, and more, and win big with real-time odds and live updates.</p>
                        </div>
                    </div>
                    ...
                    <div class="cardp">
                        <div class="cardp">
                            <div class="container-card bg-blue-box">
                                ...
                                <p class="card-title">Share Your Sports Stories</p>
                                <p class="card-description">Post your latest sports stories and share them with the world. Whether it's about your favorite team, a recent game, or a personal experience.</p>
                            </div>
                        </div>
                    </div>
                </div>
